...
const teamSwiper = new Swiper(".team__swiper", {
  ...
  (() => {
	const servicesEntryBtn = document.querySelector('.services__entry--button')
	const servicesForm = document.querySelector('.services__form')
	const servicesCrossBtn = document.querySelector('.services__cross')

	servicesEntryBtn.addEventListener('click', () => {
		servicesForm.classList.add('active')
	})

	servicesCrossBtn.addEventListener('click', () => {
		servicesForm.classList.remove('active')
	})
})();